...
"./bin/Any CPU/Release/net9.0/ProtoStripper" "${root}/Interface/swoq.proto" "${root}/Bot/ExampleGo/proto/swoq.proto"

"./bin/Any CPU/Release/net9.0/ProtoStripper" "${root}/Interface/swoq.proto" "${root}/Bot/CompleteCSharp/swoq.proto" 23
"./bin/Any CPU/Release/net9.0/ProtoStripper" "${root}/Interface/swoq.proto" "${root}/Bot/CompleteTypeScript/protos/swoq.proto" 20
