    ...
    IEnumerable<bool>? visibility = null) : IEnumerable<Cell>
{
    ...
    public Map Set(int y, int x, Cell cell)
    {
        ...
        return new Map(Level, cells, Height, Width, InitialPlayer1Position, InitialPlayer2Position, InitialEnemy1Position, InitialEnemy1Inventory, InitialEnemy2Position, InitialEnemy2Inventory, visibility);
    }
