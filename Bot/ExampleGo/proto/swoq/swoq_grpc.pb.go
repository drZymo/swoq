...
const (
	GameService_Start_FullMethodName = "/Swoq.Interface.GameService/Start"
	GameService_Act_FullMethodName   = "/Swoq.Interface.GameService/Act"
)
...
func (c *gameServiceClient) Act(ctx context.Context, in *ActRequest, opts ...grpc.CallOption) (*ActResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ActResponse)
	err := c.cc.Invoke(ctx, GameService_Act_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGameServiceServer) Start(context.Context, *StartRequest) (*StartResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Start not implemented")
}
func (UnimplementedGameServiceServer) Act(context.Context, *ActRequest) (*ActResponse, error) {
...
func _GameService_Act_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServiceServer).Act(ctx, req.(*ActRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GameService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "Swoq.Interface.GameService",
